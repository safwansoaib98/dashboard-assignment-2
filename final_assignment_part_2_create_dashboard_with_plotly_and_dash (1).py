# -*- coding: utf-8 -*-
"""Final Assignment: Part 2 - Create Dashboard with Plotly and Dash.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19vBx_qyEpRCJhkzK8fvM9cS0uxWLDRYM
"""
...
app.layout = html.Div([
    ...
    html.Div(dcc.Dropdown(
            id='select-year',
            options=[{'label': i, 'value': i} for i in year_list], # kiv
            value='Select-year',
...
def update_output_container(selected_statistics, input_year):
  ...
  if selected_statistics == 'Recession Period Statistics':
    ...
    #     # Output or return yearly data here, e.g.:
    #     return yearly_data"
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        yearly_data=data.groupby('Month')['Automobile_Sales'].sum().reset_index()
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,names='Vehicle_Type',values='Advertising_Expenditure',title="Total  Advertisement Expenditure for each vehicle"))
